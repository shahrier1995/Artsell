        ...
        <asp:View ID="OrderDetailsView" runat="server">
            ...
            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <table style="text-align: right">
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:Label ID="lblPaymentStatus" runat="server" >Paid</asp:Label></td>
                                        </tr>
                                    </table>
                ...
                <div class="col-md-4">
                        <div class="card" style="border-radius: 10px">
                            <div class="card-header">
                                <strong style="text-align: center; color: darkcyan; font-size: 20px">Order Status : Confirmed</strong>
                            </div>
                            <div class="card-body">
