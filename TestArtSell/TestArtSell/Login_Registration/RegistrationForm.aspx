<%@ Page Title="" Language="C#" MasterPageFile="~/Login_Registration/Login-RegistrationMaster.Master" AutoEventWireup="true" CodeBehind="RegistrationForm.aspx.cs" Inherits="TestArtSell.Login_Registration.RegistrationForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="card-header">
                                <div class="card-title">Buyer Registration</div>
                            </div>
                             <div class="card-body">
...
ControlToValidate="txtUserID" errormessege="Please enter your User ID" ValidationGroup="reqField" ForeColor="Red"> *</asp:RequiredFieldValidator>
                                    ...
                                    <asp:TextBox ID="txtUserID" runat="server" AutoPostBack="true"  OnTextChanged="txtUserID_TextChanged" class="form-control input-square" placeholder="User ID"></asp:TextBox>
...
ControlToValidate="txtEmail" errormessege="Please enter your Email" ValidationGroup="reqField" ForeColor="Red"> *</asp:RequiredFieldValidator>
    ...
    ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="Red">
                                    ...
                                    <asp:TextBox ID="txtEmail" onkeyup="ValidateEmail()" AutoPostBack="true"  OnTextChanged="txtEmail_TextChanged"  runat="server" class="form-control input-square" placeholder="User Email"></asp:TextBox>
