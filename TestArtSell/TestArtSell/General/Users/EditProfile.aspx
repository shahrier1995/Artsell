...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card" style="border: 3px solid #f0f0f5; border-radius: 10px">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtUserID" runat="server" onchange="UserAvailability()" ReadOnly class="form-control input-square" placeholder="User Name"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                            ControlToValidate="txtAddress" errormessege="Please enter your Address" ValidationGroup="reqField" ForeColor="Red"> *</asp:RequiredFieldValidator>
        ...
        <div class="card-action">
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="Update" class="btn btn-success" sstyle="enabled:false" ValidationGroup="reqField" OnClick="btnUpdate_Click" />
