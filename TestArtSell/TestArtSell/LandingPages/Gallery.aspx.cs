    ...
    public partial class Gallery : System.Web.UI.Page
    {
        ...
        public void LoadLandingGallery()
        {
            ...
            else
            {
                ...
                {
                    string userID = Session["UserID"].ToString();
                    string query1 = "SELECT a.ItemPhoto,a.ItemDetails,a.ItemTitle,a.ItemPrice,a.ID,a.[Status],b.wishStatus FROM tbl_Item_Info A LEFT JOIN(SELECT b.[Status] as wishStatus, b.ItemID FROM[tbl_WishList] B WHERE UserID = '" + userID + "') B ON A.ID = B.ItemID where not (a.Status='DEL' or a.Status='RE') and  CatID='" + catID+"'";
                    ds = objcda.GetDataSet(query1, "SMFM");
