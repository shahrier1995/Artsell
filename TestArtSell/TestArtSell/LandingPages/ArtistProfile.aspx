<%@ Page Title="" Language="C#" MasterPageFile="~/LandingPages/LandingMaster.Master" AutoEventWireup="true" CodeBehind="ArtistProfile.aspx.cs" Inherits="TestArtSell.LandingPages.ArtistProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Repeater ID="rptUser" runat="server" OnItemDataBound="OnItemDataBound">
        <ItemTemplate>
            ...
            <div class="row"><div class="col-md-4"></div><div class="col-md-6">
       <div class="dt-sc-fifth-fifth column">
                            <!-- Author Detail Starts Here -->
                            <div class="post-author-details">

                                <div class="entry-author-image">
                                    <a href="ArtistProfile.aspx?UserID=<%#Eval("ID") %>">
                                        <img style="width: 150px; height: 150px;" src='<%#Eval("userImage") %>' alt="" title="" /></a>
                                </div>
                                <div class="author-title">
                                    <h5><a href="#"><%#Eval("UserFullName") %></a></h5>
...
<%--                                            <div class="portfolio nature  dt-sc-one-fourth" style="background-color:white;box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);border-radius:5px">
         ...
         <script>
            ...
            function test(x, y) {
                ...
                $.ajax({
                    type: "GET",
                    url: "ArtistProfile.aspx/addRating",
